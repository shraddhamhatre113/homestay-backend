...
import { createProperty, deleteProperty, getAllProperty, getPropertyDetail, getPropertyPreview, searchProperties, getPropertyByBookingHistory, 
      updateProperty,  getTopProperties} from '../controllers/property.controller.js';
...
propertyRoutes.post('/', createProperty)
      ...
      .get('/top-properties',getTopProperties)   
      .get('/', getAllProperty)    
